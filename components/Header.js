...
export default function Header() {
    ...
    const switchLanguages = () => {
        if (document.getElementById("flag").currentLanguage == "french") {
            ...
            document.getElementById("flag").currentLanguage = "french";
            document.getElementById("flag").src = "/assets/french-flag.webp";
